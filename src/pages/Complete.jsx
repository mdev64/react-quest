...
function Complete({ totalCount, onReset }) {
  return (
    <div className="complete-page">
      <div className="confetti-row">🎉 🎊 ⚛️ 🎊 🎉</div>
      <h1 className="complete-title">You Did It!</h1>
      <p className="complete-subtitle">
        You&apos;ve completed all <strong>{totalCount}</strong> lessons in{' '}
        <strong>{APP_NAME}</strong>. You now know React from the basics all the way to advanced
        concepts!
      </p>
      ...
      <div className="certificate">
        ...
        <p className="cert-body">
          ...
          lessons in the <em>{APP_NAME}</em> interactive course, covering topics from JSX and
          Components to Context, Custom Hooks, and Performance Optimization.
        </p>
